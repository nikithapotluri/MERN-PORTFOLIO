...
export default function Projects({ darkMode }) {
  const projects = [
    {
      title: "Campus Space",
      description:
        "A MERN stack web app for booking slots in college seminar halls and labs.",
    ...
    },
    {
      title: "NGO Event Hub",
      description:
        "A MERN stack web app designed to streamline event management for NGOs.",
    ...
    },
    {
      ...
      description:
        "A Machine Learning project to detect the presence of depression and anxiety.",
  ...
  return (
    <section
      id="projects"
      className={`py-5 ${darkMode ? "dark-mode bg-secondary text-white" : "bg-white text-dark"}`}
    >
